...
#copyright 2024 nabilanavab
#thank drxxstrange@gmail.com for update.py 

file_name: str = r"ILovePDF\update.py"  # Fix Unicode error
...
def update_repository(upstream_repo: str, upstream_branch: str) -> None:
    ...
    if upstream_repo:
        ...
        try:
            ...
            logging.error(f'Something went wrong while updating: %s', e)
